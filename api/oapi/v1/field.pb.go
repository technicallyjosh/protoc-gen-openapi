...
type FieldOptions struct {
	...
	MinLength *uint64 `protobuf:"varint,5,opt,name=min_length,json=minLength,proto3,oneof" json:"min_length,omitempty"`
	// Maximum length for the field.
	MaxLength *uint64 `protobuf:"varint,6,opt,name=max_length,json=maxLength,proto3,oneof" json:"max_length,omitempty"`
	// Minimum amount of items for an array type.
	MinItems *uint64 `protobuf:"varint,7,opt,name=min_items,json=minItems,proto3,oneof" json:"min_items,omitempty"`
	// Maximum amount of items for an array type.
	MaxItems *uint64 `protobuf:"varint,8,opt,name=max_items,json=maxItems,proto3,oneof" json:"max_items,omitempty"`
	// All items in the array should be unique.
	UniqueItems *bool `protobuf:"varint,9,opt,name=unique_items,json=uniqueItems,proto3,oneof" json:"unique_items,omitempty"`
	// Minimum amount of properties that the field object can have.
	MinProperties *uint64 `protobuf:"varint,10,opt,name=min_properties,json=minProperties,proto3,oneof" json:"min_properties,omitempty"`
	// Maximum amount of properties that the field object can have.
	MaxProperties *uint64 `protobuf:"varint,11,opt,name=max_properties,json=maxProperties,proto3,oneof" json:"max_properties,omitempty"`
	// Regex pattern for the field to match. Refer to
	// https://www.ecma-international.org/ecma-262/5.1/#sec-15.10.1
	Pattern *string `protobuf:"bytes,12,opt,name=pattern,proto3,oneof" json:"pattern,omitempty"`
	// Minimum value of min excluding the defined. e.g. If min=100, 101 is the
	// min.
	ExclusiveMin *bool `protobuf:"varint,13,opt,name=exclusive_min,json=exclusiveMin,proto3,oneof" json:"exclusive_min,omitempty"`
	// Maximum value of max excluding the defined. e.g. If max=100, 99 is the max.
	ExclusiveMax *bool `protobuf:"varint,14,opt,name=exclusive_max,json=exclusiveMax,proto3,oneof" json:"exclusive_max,omitempty"`
	// The number that the value must be a multiple of.
	MultipleOf *float64 `protobuf:"fixed64,15,opt,name=multiple_of,json=multipleOf,proto3,oneof" json:"multiple_of,omitempty"`
}
...
func (x *FieldOptions) GetExample() string {
...
var file_oapi_v1_field_proto_rawDesc = []byte{
	...
	0x22, 0xfb, 0x05, 0x0a, 0x0c, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	0x70, 0x69, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x3b, 0x6f,
	0x61, 0x70, 0x69, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x4f, 0x58, 0x58, 0xaa, 0x02, 0x07, 0x4f, 0x61,
	0x70, 0x69, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x07, 0x4f, 0x61, 0x70, 0x69, 0x5c, 0x56, 0x31, 0xe2,
	0x02, 0x13, 0x4f, 0x61, 0x70, 0x69, 0x5c, 0x56, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x08, 0x4f, 0x61, 0x70, 0x69, 0x3a, 0x3a, 0x56, 0x31,
